              ...
              <div class="card">
                ...
                <?= form_open_multipart('events/fungsi_edit_events'); ?>
                  ...
                  <div class="form-group">
                      <label for="exampleInputUsername1">Event Id</label>
                      <input type="text" class="form-control" id="event_id" name="event_id" placeholder="event name"  value="<?= $queryAllevents->event_id ?>" >
                    </div>
                    <div class="form-group">
                      <label for="exampleInputUsername1">Event Name</label>
                      <input type="text" class="form-control" id="event_name" name="event_name" placeholder="event name"  value="<?= $queryAllevents->event_name ?>" >
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Event Date</label>
                      <input type="date" class="form-control" id="event_date" name="event_date" placeholder="date" value="<?= $queryAllevents->event_date?>">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">location</label>
                      <input type="text" class="form-control" id="location" name="location" placeholder="location" value="<?= $queryAllevents->location ?>">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputConfirmPassword1">organizer</label>
                      <input type="text" class="form-control" id="organizer" name="organizer" placeholder="organizer" value="<?= $queryAllevents->organizer ?>">
                    </div>
