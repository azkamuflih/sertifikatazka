              ...
              <div class="card">
                ...
                <?= form_open_multipart('certificate/fungsi_edit_certificate'); ?>
                  ...
                  <div class="form-group">
                      <!-- <label for="exampleInputUsername1">Certificate Id</label> -->
                      <input type="hidden" class="form-control" id="certificate_id" name="certificate_id" placeholder=""  value="<?= $queryAllcertificate->certificate_id ?>" >
                    </div>
                    <div class="form-group">
                      <label for="exampleInputUsername1">Participant Name</label>
                      <input type="text" class="form-control" id="participant_name" name="participant_name" placeholder=""  value="<?= $queryAllcertificate->participant_name ?>" >
                    </div>
                    <div class="form-group">
                      <label for="exampleInputUsername1">Event Name</label>
                      <input type="text" class="form-control" id="event_name" name="event_name" placeholder="event name"  value="<?= $queryAllcertificate->event_name ?>" >
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Event Date</label>
                      <input type="date" class="form-control" id="event_date" name="event_date" placeholder="date" value="<?= $queryAllcertificate->event_date?>">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Certificate Text</label>
                      <input type="text" class="form-control" id="certificate_text" name="certificate_text" placeholder="" value="<?= $queryAllcertificate->certificate_text?>">
                    </div>
