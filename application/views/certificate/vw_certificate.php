    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="col-lg-10 grid-margin stretch-card">
        ...
        <i class="fas fa-table me-1"></i>
           <a href="<?= base_url('certificate/tambah_certificate');?>" class="btn btn-primary" style="float: right;"> + tambah </a>
                    </div>
                </div>
                    ...
                    <table class="table table-bordered">
                      ...
                      <?php
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="<?= base_url('certificate/edit_certificate/' . $row->certificate_id);?>" class="btn btn-primary round btn-sm">edit<i data-feather="edit"></i></a>
